            ...
            <section className={"min-h-screen"}>
                ...
                <div className={"text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400"}>
                    <a className={"hover:scale-110 transition-transform"}
                       href={"https://www.linkedin.com/in/braian-biale/"} target={"_blank"}><AiFillLinkedin/></a>
                    <a className={"hover:scale-110 transition-transform"} href={"https://github.com/BraianBGit"}
                       target={"_blank"}><AiFillGithub/></a>
                    <a className={"hover:scale-110 transition-transform"}
                       href={"https://www.instagram.com/braianbiale/"} target={"_blank"}> <AiFillInstagram/></a>
                </div>
                <div
